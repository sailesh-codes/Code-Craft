...
import BTT from "./styles/BackToTop.module.css";

function Top() {
  const scrolltotop = () => {
    const rocket = document.querySelector("#_x32_");
    rocket.classList.add(BTT.launch);
    setTimeout(() => {
      rocket.classList.remove(BTT.launch);
    }, 1000);
    window.scrollTo({
      top: 0,
      behavior: "smooth",
  ...
  return (
    <div className={BTT.BTT}>
      <button
        id="backtotop"
        onClick={scrolltotop}
        className={`${BTT.ToTop} ${showButton ? BTT.visiblity : ""}`}
      >
        <svg
          version="1.1"
          id="_x32_"
        ...
        >
          <g>
            ...
            <path
              className="st0"
              d="M500.785,133.325c18.172-51.828,12.641-99.359-5.047-117.063c-17.703-17.688-65.234-23.219-117.047-5.047
		L500.785,133.325z"
            />
            <path
              className="st0"
              d="M491.113,156.528L355.472,20.887c-23.219,11.266-46.531,27.469-67.719,49.672
		...
		z"
            ...
            <path
              className={`${BTT.fire}`}
              d="M190.925,391.2L178.8,379.075c-13.844,51.828-81.734,69.796-81.734,69.796s25.969-31.734,27.422-53.39
